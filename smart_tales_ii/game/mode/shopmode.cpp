...
const std::array<std::string, 4> cTileImageTextures
    = {"upgradetile_light", "upgradetile_door", "upgradetile_phone", "upgradetile_furniture"};
...
const std::array<unsigned int, 4> cTilePrices = {200, 250, 300, 400};
...
bool ShopMode::SuppressDraw() const { return true; }

bool ShopMode::SuppressUpdate() const { return true; }
