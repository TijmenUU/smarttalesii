...
const std::array<std::string, 1> cFontFiles = {"font/commodore.ttf"};
...
const std::array<std::string, 2> cMusicFiles = {"music/casabossanova.ogg", "music/pixelland.ogg"};
