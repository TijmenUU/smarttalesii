...
void GameManager::Update(const sf::Time & elapsed, const Inputhandler & input, const sf::View & view)
{
...
void GameManager::SetDebugFlag(const bool flag) { debugFlag = flag; }

bool GameManager::GetDebugFlag() const { return debugFlag; }
