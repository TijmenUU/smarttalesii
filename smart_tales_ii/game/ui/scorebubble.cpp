...
void ScoreBubble::draw(sf::RenderTarget & target, sf::RenderStates states) const { target.draw(text, states); }

bool ScoreBubble::ShouldRemove() const { return timeAlive > cTimeAliveLimit; }
