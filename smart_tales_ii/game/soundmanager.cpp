...
SoundManager::SoundManager()
 : currentMusicPtr(nullptr), nextMusicPtr(nullptr), musicMuted(false), sfxMuted(false), fadeTime(0.f),
   currentFadeTime(0.f), fadeInVolumePerSecond(0.f), fadeOutVolumePerSecond(0.f), sounds()
{ }
...
bool SoundManager::IsMusicMuted() const { return musicMuted; }
...
bool SoundManager::IsSFXMuted() const { return sfxMuted; }