...
namespace Obstacle
{
    ...
    sf::Vector2f Door::GetHintPosition() const { return obstacleSprite.getPosition() + cLocalHintPosition; }
    ...
    Base * Door::Clone() const { return new Door(*this); }

    Door::Door(bool playerHasSensor)
     : GestureSensorBase(
           ResourceCache::GetInstance().GetSpriteSheet("door"),
