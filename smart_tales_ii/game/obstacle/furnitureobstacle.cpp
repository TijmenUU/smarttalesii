...
namespace Obstacle
{
    ...
    sf::Vector2f Furniture::GetHintPosition() const { return cLocalHintPosition + obstacleSprite.getPosition(); }
    ...
    Base * Furniture::Clone() const { return new Furniture(*this); }

    Furniture::Furniture(const bool playerHasSensor)
     : GestureSensorBase(
           ResourceCache::GetInstance().GetSpriteSheet("furniture"),
