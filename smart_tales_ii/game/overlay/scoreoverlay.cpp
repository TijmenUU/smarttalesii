...
void ScoreOverlay::OnEnter() { SoundManager::GetInstance().SetMusicVolume(50.f); }

bool ScoreOverlay::SuppressUpdate() const { return true; }
...
ScoreOverlay::ScoreOverlay(
 ...
 : playerScore(score), playerInventory(inventory),
